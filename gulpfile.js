...
const componentAvailableImports = {
    BoxHeader:'import LargeBox from "../Reusables/LargeBox";',
    LargeBox:'import BoxHeader from "../Reusables/BoxHeader";',
    MediumBox:'import MediumBox from "../Reusables/MediumBox";',
}
const ContainerWithHeader = {NoHeader: '', BoxHeader:`<BoxHeader children={<Trans i18nKey={"${componentName}:header"} t={t}></Trans>}/>`}

const ColorOptions = {primary:'primary', green:'green', lightgreen:'lightgreen', purple:'purple'};
...
// gulp.task("NewComponent", ["_NewComponent", "_NewTrans", "_AddToI18n","_AddToRoute" ]);  
