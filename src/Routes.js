...
const ServicesModes = React.lazy(()=>import("./components/Services/ServicesModes"));
                    ...
                    <Suspense fallback={<StyledPage/>}>
                        <ErrorBoundary>
                            <Switch>
								...
								<ContainerComponentRoute exact component={ServicesModes}  container={Page} path={"/services/modes"}/>
