    ...
    console.log(location.state)
      return (
        ...
        <StyledContainer green>
				<BoxHeader children={<Trans i18nKey={"Services:ViewHeader"} t={t}></Trans>}/>
        <Formik initialValues={{ Service_Id:location.state.Service_Id,
                                 ...
                                 Active_Status_Id:location.state.Active_Status_Id  }} validationSchema={null} onSubmit={null}>
					<Form>
						<RichInput>
          ...
          <RichInput>
            <CustomInput width={"30%"} as={"input"} id="Service_Max_Received_Time" name="Service_Max_Received_Time" type="text" label={<Trans i18nKey={"Services:Service_Max_Received_Time"} t={t}></Trans>} value={location.state.Service_Max_Received_Time}/>
          ...
          <RichInput>
            <CustomInput width={"30%"} as={"input"} id="Service_Max_Processing_Time" name="Service_Max_Processing_Time" type="text" label={<Trans i18nKey={"Services:Service_Max_Processing_Time"} t={t}></Trans>} value={location.state.Service_Max_Processing_Time}/>
          ...
          <RichInput>
            <CustomInput width={"30%"} as={"input"} id="Service_Max_Review_Time" name="Service_Max_Review_Time" type="text" label={<Trans i18nKey={"Services:Service_Max_Review_Time"} t={t}></Trans>} value={location.state.Service_Max_Review_Time}/>
          ...
          <RichInput>
            <CustomInput width={"30%"} as={"input"} id="Service_Max_Confirmation_Time" name="Service_Max_Confirmation_Time" type="text" label={<Trans i18nKey={"Services:Service_Max_Confirmation_Time"} t={t}></Trans>} value={location.state.Service_Max_Confirmation_Time}/>
          ...
          <RichInput>
          <CustomSelect value={location.state.Active_Status_Id} width={"30%"} id="Active_Status_Name" name="Active_Status_Id" label={<Trans i18nKey={"Services:Active_Status_Name"} t={t}></Trans>}>
