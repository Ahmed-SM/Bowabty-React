...
const AddUserType = () => {
  ...
  return (
    <StyledAddUser>
      <StyledContainer>
        <StyledHeader>
          <h3 align="center"><Trans i18nKey={"myTypeUsers:AddNewUserType"} t={t}> إضافة نوع مستخدم جديد</Trans></h3>
        </StyledHeader>
        <StyledDivider />
        <StyledGroup dir="auto">
          <Formik initialValues={{User_Type_Name_AR: "", User_Type_Name_EN: ""}}
            ...
            onSubmit = {add}>
              <Form>
                <StyledInputGroup>
                    ...
                    <CustomInput  name="User_Type_Name_AR" type="text" placeholder="الاسم العربى" id="ar"/>
                  <StyledColumnSpan></StyledColumnSpan>
                    <CustomInput  name="User_Type_Name_EN" type="text" placeholder=" الإسم الإنجليزى" id="en"/>
                    </StyledColumnSmall>
                  ...
                  <StyledColumnSpan>
                   ...
                   <StyledButton type="submit"><Trans i18nKey={"myTypeUsers:Enter"} t={t}>إضافة</Trans></StyledButton>
                </StyledInputGroup>
